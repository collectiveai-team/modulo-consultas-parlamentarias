...
and uses Logfire for observability, similar to the setup in the notebooks.
"""
...
class ChatApp:
    """Terminal interactive chat application with MCP server integration."""
    ...
    def _setup_logfire(self) -> None:
        """Set up Logfire instrumentation like in the notebook."""
        try:
    ...
    def _create_agent(self) -> Agent:
        ...
        - Query the parliamentary database
        - Search for deputies and their information
        - Retrieve voting records and statistics
    ...
    def _print_welcome(self) -> None:
        ...
        print("  • Votos de diputados específicos")
        print("  • Estadísticas de votaciones")
    ...
    def _print_help(self) -> None:
        ...
        print("-" * 40)
        print("• ¿Cuáles fueron los votos de Javier Milei?")
        print("• Resumen de votos de [nombre del diputado]")
        print("• ¿Cómo votó el bloque Unión por la Patria en [asunto]?")
        print("• Estadísticas de votación del diputado [nombre]")
        print("• ¿Qué asuntos se votaron en [fecha]?")
        print("-" * 40 + "\n")
    ...
    async def _process_user_input(self, user_input: str) -> bool:
        ...
        if user_input.lower() in ['salir', 'exit', 'quit']:
            print("\n👋 ¡Hasta luego! Gracias por usar el sistema de consultas parlamentarias.")
            return False
...
async def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Terminal Interactive Chat App for Parliamentary Queries"
    )
    parser.add_argument(
        "--mcp-url",
